...
import model.{ GameData, GameSession, TypedSocketCommand }
...
object CreateGameCommand extends TypedSocketCommand[NewGame]( "createGame", NewGame.form ) {
  override def executeTyped( sessionController:SessionController, sessionID:String, gameSession:Option[GameSession], data:NewGame ):Try[JsValue] = {
